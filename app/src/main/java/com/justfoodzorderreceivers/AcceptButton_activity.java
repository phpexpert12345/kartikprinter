...
public class AcceptButton_activity extends AppCompatActivity implements TimeValuesListener {

    Spinner spinner;
    String[] aa = {"10 Min","15 Min","20 Min","25 Min","30 Min","35 Min","40 Min","45 Min","50 Min","55 Min","60 Min","1 Hour 5 Min","1 Hour 10 Min","1 Hour 15 Min","1 Hour 20 Min","1 Hour 25 Min","1 Hour 30 Min","1 Hour 35 Min","1 Hour 40 Min","1 Hour 45 Min","1 Hour 50 Min","1 Hour 55 Min","2 hour"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accept_button);
        sharedPreferences = getSharedPreferences("Order", MODE_PRIVATE);
        requestQueue = Volley.newRequestQueue(this);
        driverLists = new ArrayList<>();
        myPref = new MyPref(AcceptButton_activity.this);
        ...
        parseLanguage = new ParseLanguage(myPref.getBookingData(),AcceptButton_activity.this);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AcceptButton_activity.this,android.R.layout.simple_dropdown_item_1line,aa);
...
//        }
    ...
    private void setTimeAdapter() {
        rvTime.setLayoutManager(new GridLayoutManager(AcceptButton_activity.this, 3));
        rvTime.setAdapter(new TimeAdapter(AcceptButton_activity.this, stringList, this));
    }
    ...
    {
        progressDialog = progressDialog.show(AcceptButton_activity.this,"","Please wait...",false,false);
...
//                        finish();
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(AcceptButton_activity.this, message, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("DriverComment", edt_comment.getText().toString());
...
//                Toast.makeText(getApplicationContext(),"You clicked on OK", Toast.LENGTH_SHORT).show();
    ...
    public void showDriverPoup() {
        dialog = new Dialog(AcceptButton_activity.this);
                ...
                try {
                    ...
                    for (int i = 0;i<jsonArray.length();i++){
                        ...
                        if (error==0){
                            ...
                            ReviewAdapter reviewAdapter = new ReviewAdapter(AcceptButton_activity.this, driverLists);
                            linearLayoutManager  = new LinearLayoutManager(AcceptButton_activity.this, LinearLayoutManager.VERTICAL,false);
