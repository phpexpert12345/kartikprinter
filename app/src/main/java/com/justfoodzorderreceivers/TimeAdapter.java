...
public class TimeAdapter extends RecyclerView.Adapter<TimeAdapter.Holder> {
    ...
    public TimeAdapter(Context context, ArrayList<TimeModel> lists, TimeValuesListener valuesListener) {
    ...
    public TimeAdapter(Context context, ArrayList<TimeModel> lists) {
        this.context = context;
        this.list = lists;
    }
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_time_adapter, null);
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        holder.Time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TimeAdapter.this.setResetVisibility(model);
        ...
        if (model.getSelectCategory().equalsIgnoreCase("0")) {
           // holder.view.setVisibility(View.INVISIBLE);
            holder.Time.setBackgroundResource(R.drawable.rounded_bg_two);
